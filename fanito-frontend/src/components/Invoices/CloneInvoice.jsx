...
const CloneInvoice = () => {
    const { invoiceId, typeofinvo } = useParams();
    ...
    if(!(typeofinvo === 'Invoice' || typeofinvo === 'Invoice-Receipt' || typeofinvo === 'Delivery' || typeofinvo === 'Order' || typeofinvo === 'Proforma')){
        navigate("/invoices");
    }
        ...
        >
            <div className='w-full'>
                <div className='flex justify-between border-b border-black pb-1'>
                    <h1 className="text-3xl">{splitText(`New ${typeofinvo}`)}</h1>
                ...
                <div className='flex justify-between items-center mt-5 bg-white py-5 px-5 mb-10 dark:bg-[#0E0E0E] rounded-xl shadow'>
                    <div>Payment scheduled by Fanito for 08/17/2024</div>
