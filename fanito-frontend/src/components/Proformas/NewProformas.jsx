    ...
    const handledraft = async () =>{
        ...
        try {
            ...
            if (response.status === 201) {
                ...
                navigate(`/proformas/view/${response.data.invoice_id}`);
            }
        } catch (error) {
        ...
        >
            <div className='w-full'>
                <div className='flex justify-between border-b border-black pb-1'>
                    <h1 className="text-3xl">{splitText("New Proforma")}</h1>
                ...
                :<InputClient handEmptyUser={handEmptyUser} client={client} />
                }
                ...
                <div className='flex justify-between items-center mt-5 bg-white py-5 px-5 mb-10 dark:bg-[#0E0E0E] rounded-xl shadow'>
                    ...
                    <div className='flex gap-5'>
                        ...
                        <RightButton name={'Save Proforma'} onClick={handledraft} />
                    </div>
                </div>
            </div>
