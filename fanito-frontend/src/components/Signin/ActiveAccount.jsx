...
const ActiveAccount = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-gray-100 dark:bg-gray-900">
            <div id="activeAccount" className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
                <h2 className="text-2xl font-semibold mb-6 text-center">Activate Account</h2>
                <p className="text-center text-blue-300 dark:text-blue-800">
